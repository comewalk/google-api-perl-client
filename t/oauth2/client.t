...
my $escaped_redirect_uri = uri_escape($redirect_uri);
is ref($auth_driver),           'Google::API::OAuth2::Client';
is $auth_driver->authorize_uri, "$auth_uri?client_id=$client_id&redirect_uri=$escaped_redirect_uri&response_type=code&scope=openid";
...
is ref($auth_driver),           'Google::API::OAuth2::Client';
is $auth_driver->authorize_uri, "$auth_uri?client_id=$client_id&redirect_uri=$escaped_redirect_uri&response_type=code&scope=openid&access_type=offline";
...
is $auth_driver->authorize_uri, "$auth_uri?client_id=$client_id&redirect_uri=$escaped_redirect_uri&response_type=code&scope=" . uri_escape('https://www.googleapis.com/auth/urlshortener');
